    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed z-40 bottom-22 right-4 md:bottom-6 md:right-6 group select-none outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#0c0f17]"
        >
          {/* Pill Container */}
          <div className="flex items-center gap-2.5 sm:gap-3 px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-full backdrop-blur-2xl transition-all duration-300 border bg-white/90 dark:bg-[#0e1117]/90 border-black/10 dark:border-white/10 shadow-[0_12px_30px_-12px_rgba(14,165,233,0.35)] hover:scale-[1.02] active:scale-[0.99]">
            ...
            <kbd
              aria-hidden="true"
              className="hidden lg:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-mono font-medium rounded bg-neutral-100 dark:bg-white/10 text-neutral-500 dark:text-neutral-400 border border-neutral-200/80 dark:border-white/10"
            >
              ⌘K
            </kbd>
          </div>
        ...
        <>
          ...
          <div
            ...
            className="fixed z-50 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]
              ...
              md:inset-x-auto md:bottom-6 md:right-6 md:w-[420px] md:max-w-[calc(100vw-2rem)] md:h-[620px] md:max-h-[calc(100vh-4.5rem)] md:rounded-[28px] md:border md:border-black/10 md:dark:border-white/15 md:shadow-[0_20px_60px_rgba(15,23,42,0.18)]
