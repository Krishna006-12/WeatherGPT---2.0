                ...
                <div className="max-w-[92%] space-y-3">
                  {m.error ? (
                    ...
                    >
                      ...
                      {/* Grounded Attribution: Real Data Sources & AI Analysis Engine */}
                      {m.response?.citations && m.response.citations.length > 0 && (
                        <div
                          className="mt-3 pt-3 border-t border-[var(--border-subtle)] space-y-2.5"
                          role="region"
                          aria-label="Data sources and AI attribution"
                        >
                          {/* Row 1: Attribution Header with AI Analysis by Google Gemini Badge */}
                          <div className="flex flex-wrap items-center justify-between gap-2">
                            ...
                            {/* Distinct Gemini AI Reasoning Badge */}
                            <div
                          ...
                          {/* Row 2: Grounded Real Data Source Chips */}
                          <div className="flex flex-wrap gap-2" role="list" aria-label="Verified meteorological and event data sources">
                            {m.response.citations.map((c, i) => (
                              <div
                                key={i}
                                role="listitem"
                                aria-label={`Data sourced from ${c.source}: ${c.title}`}
                                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] border border-[var(--border-subtle)] bg-[var(--surface-2)] text-[var(--text-secondary)] hover:border-[var(--accent-border)] transition-colors"
                              >
